...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  //hotelsCopy.sort(sortHotelsByPricing);
...
app.get('/hotels/filter/amenity', (req, res) => {
  let amenity = req.query.amenity || 'spa'; //here writing  || spa is not compulsory this is optional.
...
app.get('/hotels/filter/category', (req, res) => {
  let category = req.query.category || 'luxury';
  let results = hotels.filter((hotel) => filterByCategory(hotel, category));
  res.json({ hotels: results });
});

//endpoint 7 load all hotels
